...
/*TODO: Описать работу функций simplesecond.h(не забыть про init_app,
указать какую структуру заполняет)*/
/*TODO: описать доп функции которые сопровождают основные функции в simplesecond.c*/
/*TODO: Описать назначение каждого перечесления и структуры в types_rep.h*/
/*TODO: Описать доп функции в rep_find.c*/
/*TODO: переделать show_info_dev_handle в нормальный вид, чтобы для
начала можно было проанализировать правильность работы программы.
сделать доп функцию чтобы собарать массив строки и отправлять его уже в ui*/
...
/*TODO: ПРОВЕРИТЬ РАБОТУ ДИНАМИЧЕСКОЙ ПАМЯТИ, (ВОЗМОЖНО ЛУЧШЕ НАПИСАТЬ ТЕСТЫ НА ВСЮ ПРОГРАММУ)
*/
int main(void)
{
	AppState app;
